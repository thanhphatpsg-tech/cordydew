...
(function ($) {
  "use strict"; // Loading Box (Preloader)
  ...
  if ($('.navigation li.dropdown ul').length) {
    $('.navigation li.dropdown').append('<div class="dropdown-btn"><span class="fa fa-angle-right"></span></div>'); //Dropdown Button
  ...
  new WOW().init(); // four Item Carousel (team)
  ...
  */
  ...
  if ($('.coming-soon-inner').length !== 0) {
    var second = 1000,
        ...
        hour = minute * 60,
        day = hour * 24;
    var countDown = new Date('Jan 12, 2022 00:00:00').getTime(),
